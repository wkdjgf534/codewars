...
# and add to the original number". If the resulting number is not a palindrome, repeat the
...
def palindrome_chain_length(num)
  counter = 0
  until num == num.to_s.reverse.to_i
...
describe '#palindrome_chain_length' do
  it 'returns a step value when a number is a palindrome' do
