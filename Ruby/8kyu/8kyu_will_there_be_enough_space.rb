...
# has to face the problem of not enough space left on the bus! He wants you to write a simple
...
describe '#enough' do
  it 'returns 0' do
    expect(enough(10, 5, 5)).to eq(0)
  end

  it 'returns 0' do
    expect(enough(20, 5, 5)).to eq(0)
  end

  it 'returns 10' do
    expect(enough(100, 60, 50)).to eq(10)
  end
end
