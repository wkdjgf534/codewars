...
def sum_array(array)
  array.nil? || array.empty? ? 0 : array.sort.slice(1..-2).sum
end

p sum_array([6, 0, 1, 10, 10])

describe '#sum_array' do
  it 'calculates all elements of an array expect the lowest and the highest' do
  ...
  it 'returns 0 if given a nil' do
